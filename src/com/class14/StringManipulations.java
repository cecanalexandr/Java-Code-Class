...
public class StringManipulations {
	...
	public static void main(String[] args) {
		...
		//2 replaceAll() -will replace all that maches specifil pattern [regex];
		String str1="12Hello 3234 Work 465^%";
		String replacedNoNumbers=str1.replaceAll("[0-9]","" );
		System.out.println(replacedNoNumbers);
		
		String newString=replacedNoNumbers=replacedNoNumbers.replaceAll("[A-Za-z]", "");
