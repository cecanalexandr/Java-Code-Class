...
public class Stringmethod {
	...
	public static void main(String[] args) {
		...
		*         */
	     ...
	     *  Checks whether the string/paragraph starts and ends 
	     *  with the string or word "The" and prints.         
	     ...
	     *   */        
              String  para = new String( "The quick brown fox jumps over the lazy dog.");
             System.out.println(para.toUpperCase());
              
              
              int par1=para.length();
              System.out.println(par1);
              System.out.println(para.charAt(2));
	}
